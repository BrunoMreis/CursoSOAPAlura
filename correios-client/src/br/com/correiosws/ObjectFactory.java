 ...
 * generated in the br.com.correiosws package. 
...
public class ObjectFactory {
    ...
    private final static QName _CResultadoModal_QNAME = new QName("http://tempuri.org/", "cResultadoModal");
    private final static QName _CResultadoServicos_QNAME = new QName("http://tempuri.org/", "cResultadoServicos");
    ...
    private final static QName _Versao_QNAME = new QName("http://tempuri.org/", "versao");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.correiosws
     * 
     */
    ...
    /**
     * Create an instance of {@link CResultadoModal }
     * 
     */
    public CResultadoModal createCResultadoModal() {
        return new CResultadoModal();
    }
    ...
    /**
     * Create an instance of {@link CalcDataMaxima }
     * 
     */
    public CalcDataMaxima createCalcDataMaxima() {
        return new CalcDataMaxima();
    }
    ...
    /**
     * Create an instance of {@link VerificaModalResponse }
     * 
     */
    public VerificaModalResponse createVerificaModalResponse() {
        return new VerificaModalResponse();
    }
    ...
    /**
     * Create an instance of {@link ListaServicos }
     * 
     */
    public ListaServicos createListaServicos() {
    ...
    /**
     * Create an instance of {@link GetVersaoResponse }
     * 
     */
    public GetVersaoResponse createGetVersaoResponse() {
        return new GetVersaoResponse();
    }
    ...
    /**
     * Create an instance of {@link GetVersao }
     * 
     */
    public GetVersao createGetVersao() {
        return new GetVersao();
    }
    ...
    /**
     * Create an instance of {@link CResultadoServicos }
     * 
     */
    public CResultadoServicos createCResultadoServicos() {
        return new CResultadoServicos();
    }
    ...
    /**
     * Create an instance of {@link CalcPrazoNovo }
     * 
     */
    public CalcPrazoNovo createCalcPrazoNovo() {
        return new CalcPrazoNovo();
    }

    /**
     * Create an instance of {@link CalcPrazoNovoResponse }
     * 
     */
    public CalcPrazoNovoResponse createCalcPrazoNovoResponse() {
        return new CalcPrazoNovoResponse();
    }
    ...
    /**
     * Create an instance of {@link CalcDataMaximaResponse }
     * 
     */
    public CalcDataMaximaResponse createCalcDataMaximaResponse() {
        return new CalcDataMaximaResponse();
    }

    /**
     * Create an instance of {@link ListaServicosSTARResponse }
     * 
     */
    public ListaServicosSTARResponse createListaServicosSTARResponse() {
        return new ListaServicosSTARResponse();
    }
    ...
    /**
     * Create an instance of {@link VerificaModal }
     * 
     */
    public VerificaModal createVerificaModal() {
        return new VerificaModal();
    }
    ...
    /**
     * Create an instance of {@link ListaServicosSTAR }
     * 
     */
    public ListaServicosSTAR createListaServicosSTAR() {
        return new ListaServicosSTAR();
    }
    ...
    /**
     * Create an instance of {@link ListaServicosResponse }
     * 
     */
    public ListaServicosResponse createListaServicosResponse() {
    ...
    /**
     * Create an instance of {@link CModal }
     * 
     */
    public CModal createCModal() {
        return new CModal();
    }
    ...
    /**
     * Create an instance of {@link ArrayOfCServicosCalculo }
     * 
     */
    public ArrayOfCServicosCalculo createArrayOfCServicosCalculo() {
        return new ArrayOfCServicosCalculo();
    }
    ...
    /**
     * Create an instance of {@link ArrayOfCModal }
     * 
     */
    public ArrayOfCModal createArrayOfCModal() {
        return new ArrayOfCModal();
    }

    /**
     * Create an instance of {@link CServicosCalculo }
     * 
     */
    public CServicosCalculo createCServicosCalculo() {
        return new CServicosCalculo();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CResultadoModal }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "cResultadoModal")
    public JAXBElement<CResultadoModal> createCResultadoModal(CResultadoModal value) {
        return new JAXBElement<CResultadoModal>(_CResultadoModal_QNAME, CResultadoModal.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CResultadoServicos }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "cResultadoServicos")
    public JAXBElement<CResultadoServicos> createCResultadoServicos(CResultadoServicos value) {
        return new JAXBElement<CResultadoServicos>(_CResultadoServicos_QNAME, CResultadoServicos.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "versao")
